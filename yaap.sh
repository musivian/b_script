...
git clone https://github.com/yaap/device_xiaomi_sunny.git --depth 1 -b fifteen device/xiaomi/sunny
...
git clone https://github.com/yaap/vendor_yaap.git --depth 1 -b fifteen vendor/xiaomi/sunny
